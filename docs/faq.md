...
2. For Windows users, proposals are saved in the Documents folder at C:\Users\<username>\Documents\Propongo2\proposals.
3. For MacOS users, proposals are saved in the the Documents folder.
