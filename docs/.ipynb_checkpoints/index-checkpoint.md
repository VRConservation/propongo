...
# Welcome to Propongo
[Propongo](https://propongo.org) is a proposal generator for conservation and natural resource projects. Create professional proposals with scope of work, budgets, qualifications, timelines, and export to PDF, Word, or HTML. The app features English, French, and Spanish versions.
...
- **Project tracking** - Once a proposal is funded, use it to track project status, budget spending, and a dashboard to manage the project.
